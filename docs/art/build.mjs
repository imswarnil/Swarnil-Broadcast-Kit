...
function banner(t) {
	...
	p.push(text(72, 240, 'A native plugin, not a browser source: fifteen sources, six filters,', { size: 17, fill: t.dim }));
	p.push(text(72, 266, 'a transition, a control dock and a show of eighteen scenes.', { size: 17, fill: t.dim }));
