...
for (const f of fs.readdirSync(path.join(ROOT, 'skills/sbk-scenes/examples')))
	specs.push({
		rel: `examples/${f}`,
		spec: JSON.parse(fs.readFileSync(path.join(ROOT, 'skills/sbk-scenes/examples', f), 'utf8')),
	});
